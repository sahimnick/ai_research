...
class UnifiedMind:
    ...
    def live(self, world=None, steps: int = 1000, n_places: int = 8,
        ...
        from .loop import SensoryWorld, CognitiveLoop
    ...
    def sleep(self, cycles: int = 3, replays_per_cycle: int = 300) -> int:
        ...
        if self.episodes is None or len(self.episodes) == 0:
            return 0
        from .development import SleepConsolidator
...
def build_unified_mind(n_pallium: int = 4000, verbose: bool = False):
    ...
    from .realworld import build_digit_recognizer, load_mnist
    from .psyche import MentalSpace
    ...
    from .objects import build_causal_world
    from .selfmodel import build_self_model
    from .development import EpisodicBuffer
    ...
    from .objects import causal_generalisation_score
...
def pallium_capacity_curve(sizes=(50, 200, 1000, 4000), n_train: int = 15000
    ...
    from .realworld import build_digit_recognizer, load_mnist
    from .psyche import AssociativeCortex
