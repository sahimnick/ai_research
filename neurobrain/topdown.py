...
class GrowthSchedule:
    ...
    def run(self, v1: WideV1, images: Sequence[np.ndarray], v2=None,
        ...
        from .selforganize import develop_v1
        from .v2binding import v1_parts
...
def staged_vs_simultaneous(n_v1: int = 512, n_v2: int = 64,
    ...
    from .composite import composite_dataset, LocalV2
    from .selforganize import randomise_filters, develop_v1
...
def error_driven_looking_experiment(n_v1: int = 512, n_high: int = 96,
    ...
    from .realworld import load_mnist
    from .streams import build_scene, SaccadicEye
    from .selforganize import randomise_filters, develop_v1
