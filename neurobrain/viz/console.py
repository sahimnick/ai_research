...
class BrainConsole:
    ...
    def __init__(self, scene_size: int = 256, n_objects: int = 12,
        ...
        from ..sensing.streams import (build_scene, SaccadicEye, build_soundscape,
                              StreamingBrain)
        ...
        from ..vision.spikingvision import SpikingCategoryMap
        from ..vision.widev1 import VIGILANCE_LADDER
